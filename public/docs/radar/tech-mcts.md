# 双层MCTS：让 Agent Skills 的结构和内容一起自动进化

**一句话描述**：将 Skills 优化建模为**双层优化问题**——外层用 MCTS 搜索最优技能结构（章节组织、文件拆分），内层用 LLM 精炼具体内容，在 ORQA 基准上**自动优化的技能反超了人工手调版本**（90.625% → 93.75%）。
...
1. [论文](https://arxiv.org/abs/2604.15709)
2. [详解](https://zhuanlan.zhihu.com/p/2030972051096332121)
