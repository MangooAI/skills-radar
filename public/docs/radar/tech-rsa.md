...
> **分类**: Agent 技能管理 | **成熟度**: 🟡 成长期 | **综合评分**: 0.52
...
| 维度 | 评分 (0.0-1.0) | 说明 |
|------|---------------|------|
| 技术成熟度 | 0.55 | 运行时行为审计方案可直接集成到现有Agent框架 |
| 创新性 | 0.60 | 静态→运行时的安全评估范式转移思路鲜明 |
| 落地程度 | 0.40 | 准确率90.0%，自进化攻击下持续检出19-20/20 |
| 生态活跃度 | 0.50 | JHU出品，有GitHub开源代码 |
