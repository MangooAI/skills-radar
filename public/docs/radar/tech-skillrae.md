...
> **分类**: Skill 召回 | **成熟度**: 🔴 探索期 | **综合评分**: 0.43

---

## 一句话描述

SkillRAE 在检索和执行之间塞了一个**编译器**——把搜出来的技能和子单元重新组织成紧凑、可执行的上下文包，不改下游任何东西，只优化 Agent 看到的信息组织方式，在 SkillsBench 上带来了 **11.7%** 的提升，甚至**超过了人工指定的 curated skills（+3.06pp）**。
...
- [论文](https://arxiv.org/pdf/2605.10114)
- [详解](https://zhuanlan.zhihu.com/p/2041215811801571918)