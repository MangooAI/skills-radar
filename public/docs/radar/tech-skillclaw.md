...
> **分类**: Skill 优化 | **成熟度**: 🟡 成长期 | **综合评分**: 0.48

---

## 一句话描述

SkillClaw 在多个用户独立部署的 Agent 之间搭了一个**集中的技能进化闭环**——白天自动收集交互轨迹，夜晚用 LLM 驱动的"进化器"分析失败模式并修正技能，验证通过后自动同步给所有用户，在 WildClawBench 上 6 天内实现 Search **+52%**、Creative **+88.41%**、Social **+11.72%**、Safety **+33.33%** 的全面提升。
...
- [论文](https://arxiv.org/pdf/2604.08377)
