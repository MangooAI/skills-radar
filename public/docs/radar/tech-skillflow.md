# SKILLFLOW：Agent 技能会"越学越笨"吗？

**一句话描述**：SKILLFLOW 提出了首个 Agent 技能的**终身学习评测基准**，覆盖 11 个主流模型，系统评估了技能持续更新过程中的退化与回归——结论是：**大部分模型在连续技能更新后确实会越学越差**，且退化幅度和模型基座能力并非线性相关，强模型不一定更稳。
...
1. [项目](https://zhangzi-a.github.io/SkillFlow-project-page/)
2. [论文](https://arxiv.org/pdf/2604.17308)
3. [代码](https://github.com/ZhangZi-a/SkillFlow)
4. [详解](https://zhuanlan.zhihu.com/p/2030587991689785774)
