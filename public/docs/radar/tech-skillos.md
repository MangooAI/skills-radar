# SkillOS：告别"用完即弃"——用 RL 训练一个技能管家

**一句话描述**：Google Cloud AI Research 联合 UIUC 和 MIT 提出 SkillOS——用一个**8B 参数的小模型当技能策展人**，通过 GRPO 强化学习学会什么时候新建、更新、删除技能，结果是**8B 策展人在管技能这件事上直接碾压了 Gemini-2.5-Pro**（61.2% vs 53.1%）。
...
1. [论文](https://arxiv.org/pdf/2605.06614)
2. [详解](https://zhuanlan.zhihu.com/p/2036102058797946620)
